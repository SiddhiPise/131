...
p_planet_masses = []
p_planet_names = []
for planet_data in _planets:
  p_planet_masses.append(planet_data[3])
  p_planet_names.append(planet_data[1])

p_planet_masses.append(1)
p_planet_names.append("Earth")

fig = px.bar(x=p_planet_names, y=p_planet_masses)
fig.show()
